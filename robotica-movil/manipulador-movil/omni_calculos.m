...
% Matriz Jacobiana
J = [diff(vt(1), p1) diff(vt(1), p2) diff(vt(1), p3) diff(vt(1), q1) diff(vt(1), q2) diff(vt(1), q3);
    diff(vt(2), p1) diff(vt(2), p2) diff(vt(2), p3) diff(vt(2), q1) diff(vt(2), q2) diff(vt(2), q3);
    diff(vt(3), p1) diff(vt(3), p2) diff(vt(3), p3) diff(vt(3), q1) diff(vt(3), q2) diff(vt(3), q3)];
